...
export const Main = () => {
  return (
    <div className="h-[55vh] relative">
      <div className="main h-full w-full rounded-tl-[115px] rounded-br-[115px] flex flex-col items-center justify-center gap-10">
        <div className="flex flex-col h-full items-center  w-full  gap-[25%] pt-[40px] pl-[6.5vw] justify-center">
          ...
          <div className="flex flex-col items-center justify-center gap-5 w-[70vw] max-w-[850px]">
            <h1 className="relative z-50 headerMega  text-nowrap text-shadow below-lg:!text-5xl">
              Explore Privacy
            </h1>
            <SearchBar />
          </div>
