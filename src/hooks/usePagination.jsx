      ...
      <div className="flex  pt-2 w-full justify-between text-xs font-light">
        <div className="flex gap-2">
          ...
          <input
            ...
            className="bg-purpleOp50 outline-2 outline-pastelPurple outline  flex items-center justify-center text-white px-3 h-7 rounded-lg w-12"
          ></input>
        </div>
        <div className="flex gap-2">
          <div className="flex gap-2">
            ...
            <input
              ...
              className="bg-purpleOp50 outline-2 outline-pastelPurple outline  flex items-center justify-center text-white px-3  rounded-lg w-12"
            ></input>
          </div>
          <div
            onClick={() => setPage(1)}
